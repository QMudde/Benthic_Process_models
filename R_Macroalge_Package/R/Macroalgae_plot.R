...
# ==============================================================================
# Plot function for class dtMacroalgae that also adds the units to the y labels.
# ==============================================================================

plot.dtMacroalgae <- function(x, ..., select = NULL, which = select, 
  ...
  classx <- class(x)   
  class(x) <- classx[-which(classx == "dtMacroalgae")]
